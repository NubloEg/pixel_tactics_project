...
export const AllAchievements: IAchievement[] = [
  {
    id: "6",
  ...
  },
  {
    ...
    description: "Используйте 5 или более способностей, которые усиливают союзников.",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    description: "Победите, используя юнита, который был разыгран в последний момент.",
  },
  {
    id: "12",
  ...
  },
  {
    ...
    name: "Счастливчик",
    description: "Выиграйте игру, несмотря на то, что у вас остался только лидер.",
  },
  {
    id: "14",
  ...
  },
  {
    ...
    description: "Выиграйте игру, имея меньше юнитов на поле, чем ваш противник.",
  },
  {
    id: "18",
    icon: "https://cdn3.iconfinder.com/data/icons/fantasy-and-role-play-game-adventure-quest/512/Medusa-1024.png",
    name: "Без пощады",
    description: "Уничтожьте все юниты противника до того, как атаковать лидера.",
  },
];
